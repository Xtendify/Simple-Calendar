...
class System_Status extends Admin_Page {
	...
	public function html() {
		...
		$sections['wordpress'] = array(
			...
			'debug_mode'   => array(
				'label'        => __( 'WP Debug Mode', 'google-calendar-events' ),
				'label_export' => 'WP Debug Mode',
				'result'       => $debug_mode,
			),
			'script_debug' => array(
				'label'        => __( 'Script Debug', 'google-calendar-events' ),
		...
		$sections['server'] = array(
			...
			'wp_remote_post'      => array(
				'label'         => __( 'WP Remote POST', 'google-calendar-events' ),
				'label_export'  => 'WP Remote POST',
				'result'        => $wp_post,
				'result_export' => $wp_post_export,
			),
			'wp_remote_get'       => array(
				'label'         => __( 'WP Remote GET', 'google-calendar-events' ),
