...
class Welcome
{
	...
	private function intro()
	{
		?>
		<h1>
			 /* translators: %s prints the current version of the plugin. */ /* translators: %s prints the current version of the plugin. */<?php /* translators: %s prints the current version of the plugin. */
    printf(
   ...
   ?>
	...
	public function about_screen()
	{
		...
		<div id="simcal-welcome">
			<div class="wrap about-wrap whats-new-wrap">
				...
				<h3><?php _e(
    	'Configure event colors, number of events to display, grid or list style and more.',
    	'google-calendar-events'
    ); ?></h3>
	...
	'google-calendar-events'
				...
				<a href="<?php echo $welcome_addons_link; ?>" target="_blank"><img src="<?php echo $welcome_image_about_path .
	'/fullcalendar-google-calendar-pro-grid-view.png'; ?>" /></a>

				<h3><a href="<?php echo $welcome_addons_link; ?>" target="_blank"><?php _e(
	'View Pricing and Try a Demo of our Simple Calendar Pro Add-ons.',
	'google-calendar-events'
); ?></a></h3>
		...
		<div id="simcal-welcome">
			<div class="wrap about-wrap credits-wrap">
				...
				<p class="about-description">
					<?php printf(
     	__(
     		"Simple Calendar is created by a worldwide team of developers. If you'd like to contribute please visit our <a href='%s' target='_blank'>GitHub repo</a>.",
     		'google-calendar-events'
     	),
	...
	public function translators_screen()
	{
		...
		<div id="simcal-welcome">
			<div class="wrap about-wrap translators-wrap">
				...
				<p class="about-description">
					<?php _e(
     	'Simple Calendar has been kindly translated into several other languages by contributors from all over the world.',
     	'google-calendar-events'
     ); ?>
				</p>
				<p class="about-description">
					<a href="https://translate.wordpress.org/projects/wp-plugins/google-calendar-events" target="_blank"><?php _e(
     	'Click here to help translate',
     	'google-calendar-events'
     ); ?></a>
				</p>
				<?php // Transifex API is not open and requires authentication,
