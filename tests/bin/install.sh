...
install_test_suite() {
	...
	sed $ioption "s/wptests_/plugintests_/" wp-tests-config.php
	sed $ioption "s/example.org/mockdomain.dev/" wp-tests-config.php
	sed $ioption "s/admin@example.org/tests@mockdomain.dev/" wp-tests-config.php
	sed $ioption "s/Test Blog/Plugin Unit Tests/" wp-tests-config.php
}
