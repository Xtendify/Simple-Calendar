...
class EventTest extends TestCase
{
    private function makeEvent(array $overrides = []): Event
    {
        $defaults = [
            ...
            'start_location' => ['name' => 'Office', 'address' => '123 Main St', 'lat' => 40.7128, 'lng' => -74.0060],
            'end_location' => '',
            'whole_day' => false,
            'multiple_days' => false,
            'recurrence' => false,
            'meta' => ['color' => '#ff0000', 'attendees' => [['name' => 'Alice']], 'organizer' => ['name' => 'Bob'], 'attachments' => [['url' => 'file.pdf']]],
